set job.name 'AIRLINE_EX3_GROUP02';

%declare INPUT_PATH '/home/ntkhoa/IdeaProjects/CloudLabEurecom-Pig/local-input/AIRLINE/2008.csv';
%declare OUTPUT_PATH '/home/ntkhoa/IdeaProjects/CloudLabEurecom-Pig/local-output/AIRLINE/EX3/';
