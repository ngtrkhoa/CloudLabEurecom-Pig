...
set job.name 'TCP_COUNT2_GROUP02';

%declare INPUT_PATH '/home/ntkhoa/IdeaProjects/CloudLabEurecom-Pig/local-input/tstat-sample.txt';
%declare OUTPUT_PATH '/home/ntkhoa/IdeaProjects/CloudLabEurecom-Pig/local-output/STAT/TCP-2/';
...
DATA = FOREACH RAW_DATA GENERATE ip_c, $110;
DATA_FILTERED = FILTER DATA BY $1 MATCHES '.*google.com.*';

--dump DATA_FILTERED;
--describe DATA_FILTERED;


-- Count #connections
COUNT_GROUP = GROUP DATA_FILTERED ALL;
COUNT = FOREACH COUNT_GROUP GENERATE COUNT_STAR(DATA_FILTERED);
