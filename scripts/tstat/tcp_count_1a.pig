...
set job.name 'TCP_COUNT1A_GROUP02';

%declare INPUT_PATH '/home/ntkhoa/IdeaProjects/CloudLabEurecom-Pig/local-input/tstat-sample.txt';
%declare OUTPUT_PATH '/home/ntkhoa/IdeaProjects/CloudLabEurecom-Pig/local-output/STAT/TCP-COUNT1A/';
...
-- Group by client IP
FLOW = GROUP LOGS BY ip_c;

-- Generate the output data
TRAFFIC = FOREACH FLOW GENERATE group, COUNT(LOGS);
