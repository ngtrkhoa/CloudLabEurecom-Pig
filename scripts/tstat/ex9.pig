...
set job.name 'TCP_9_GROUP02';

%declare INPUT_PATH '/home/ntkhoa/IdeaProjects/CloudLabEurecom-Pig/local-input/tstat-sample.txt';
%declare OUTPUT_PATH '/home/ntkhoa/IdeaProjects/CloudLabEurecom-Pig/local-output/STAT/TCP-9/';
...
DATA = FOREACH RAW_DATA GENERATE port_s as port;
...
COUNT_GROUP = FOREACH DATA_GROUP GENERATE (double)100 * COUNT_STAR(DATA_FILTERED) / COUNT_ALL.total;

-- Store the output
STORE COUNT_GROUP INTO '$OUTPUT_PATH';
