...
set job.name 'TCP_6_GROUP02';

%declare INPUT_PATH '/home/ntkhoa/IdeaProjects/CloudLabEurecom-Pig/local-input/tstat-sample.txt';
%declare OUTPUT_PATH '/home/ntkhoa/IdeaProjects/CloudLabEurecom-Pig/local-output/STAT/TCP-6/';
...
DATA = FOREACH RAW_DATA GENERATE mss_c;

DATA_SORTED = ORDER DATA BY mss_c;
DATA_MIN = LIMIT DATA_SORTED 1;


-- Store the output
STORE DATA_MIN INTO '$OUTPUT_PATH';
